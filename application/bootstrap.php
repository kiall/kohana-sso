...
/**
 * Enable a PEAR style auto-loader and update the include path.
 */
spl_autoload_register('PEAR::autoload');
set_include_path(get_include_path().':'.APPPATH.'vendor/php-openid/');
...
Kohana::modules(array(
	...
	'auth-driver-orm' => MODPATH.'auth-driver-orm',
